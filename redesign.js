...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	function Wa(e) {
		...
		function f(e, t, n) {
			...
			if (typeof t == "object" && t) {
				...
				if (ue(t) || ce(t)) return t = Si(t, e.mode, n, null), t.return = e, t;
	...
	nerv: ["p2", "ウィンドエアロ"],
	toyota: ["p3", "AURA"],
	niconico: ["p4", "ニコニコ・クラシック"]
};
function ue() {
	let [e, t] = (0, S.useState)(() => window.CmsRedesign.snapshot());
	return (0, S.useEffect)(() => {
		let e = () => t(window.CmsRedesign.snapshot()), n = () => requestAnimationFrame(e);
		window.addEventListener("cms-state-change", e), window.addEventListener("resize", n);
		let r = matchMedia("(prefers-color-scheme: light)");
		return r.addEventListener("change", n), e(), () => {
			window.removeEventListener("cms-state-change", e), window.removeEventListener("resize", n), r.removeEventListener("change", n);
		};
	}, []), e;
}
function T(e, t) {
	let n = document.getElementById(e);
	n && ((n.dataset.designClasses || "").split(" ").filter(Boolean).forEach((e) => n.classList.remove(e)), t.split(" ").filter(Boolean).forEach((e) => n.classList.add(e)), n.dataset.designClasses = t);
}
function E() {
	let e = ue(), t = le[e.theme]?.[0] || "p1";
	return (0, S.useEffect)(() => {
		document.body.classList.add("cms-redesign"), document.body.classList.toggle("color-light", e.light), document.body.classList.toggle("color-dark", !e.light);
		for (let e of [
			"p1",
			"p2",
			"p3",
			"p4"
		]) document.body.classList.toggle(`theme-${e}`, e === t);
		let n = e.desktop;
		T("main-app", n ? `${t}-web` : "");
		let r = t === "p1" ? {
			"left-pane": "p1-player",
			"right-pane": "p1-library",
			"widget-player": "video",
			"widget-controls": "p1-now",
			"widget-folder-list-wrapper": "p1-fold"
		} : t === "p2" ? {
			"widget-player": "preview",
			"widget-controls": "aero-player",
			"widget-folder-list-wrapper": "aero-fold",
			"right-pane": "aero-main"
		} : t === "p3" ? {
			"widget-player": "module visual",
			"widget-controls": "module active-media",
			"widget-folder-list-wrapper": "module archive",
			"widget-library": "module entries"
		} : {
			"widget-player": "retro-player",
			"widget-controls": "retro-now",
			"widget-folder-list-wrapper": "retro-fold",
			"right-pane": "retro-list"
		};
		for (let e of [
			"left-pane",
			"right-pane",
		...
		className: "switcher cms-live-switcher",
		"aria-label": "表示スタイル",
		children: [
			/* @__PURE__ */ (0, w.jsx)("b", { children: "TUBENICO" }),
			/* @__PURE__ */ (0, w.jsx)("div", {
				className: "cms-theme-choices",
				children: Object.entries(le).map(([t, [n, r]]) => /* @__PURE__ */ (0, w.jsxs)("button", {
					className: e.theme === t ? "on" : "",
					"aria-pressed": e.theme === t,
					onClick: () => window.CmsRedesign.set({ theme: t }),
					children: [
						n.toUpperCase(),
						" ",
						r
			...
			/* @__PURE__ */ (0, w.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, w.jsxs)("label", { children: ["配色", /* @__PURE__ */ (0, w.jsxs)("select", {
					"aria-label": "配色",
					value: e.color,
					onChange: (e) => window.CmsRedesign.set({ colorMode: e.target.value }),
					children: [
					...
					type: "checkbox",
					checked: e.reduced,
					onChange: (e) => window.CmsRedesign.set({ performanceMode: e.target.checked })
				}), "軽量化"] })]
			}),
			/* @__PURE__ */ (0, w.jsxs)("div", {
				className: "cms-utility-actions",
				children: [/* @__PURE__ */ (0, w.jsxs)("button", {
					onClick: () => window.CmsRedesign.history(),
					children: [/* @__PURE__ */ (0, w.jsx)(ie, { size: 16 }), "履歴・統計"]
				}), /* @__PURE__ */ (0, w.jsxs)("button", {
					onClick: () => window.CmsRedesign.settings(),
					children: [/* @__PURE__ */ (0, w.jsx)(oe, { size: 16 }), "設定"]
				})]
			})
		]
	});
...
function de() {
	let e = ue(), t = e.folder === "__all" ? "すべて" : e.folder === "__history" ? "再生履歴" : e.folder === "__vocaloid" ? "ボカロ / Kiite" : e.folder;
	return /* @__PURE__ */ (0, w.jsxs)("button", {
		className: "cms-playing-origin",
		disabled: !e.folder || e.folder === "__history",
		onClick: () => window.CmsRedesign.locate(),
		title: "再生開始元のフォルダと曲を表示",
		children: [/* @__PURE__ */ (0, w.jsx)(ae, { size: 15 }), /* @__PURE__ */ (0, w.jsxs)("span", { children: ["再生元：", t || "未再生"] })]
	});
}
function fe() {
	let e = document.getElementById("cms-design-toolbar");
	e && (0, se.createRoot)(e).render(/* @__PURE__ */ (0, w.jsx)(E, {}));
	let t = document.getElementById("widget-artist");
	if (t) {
		let e = document.createElement("div");
		e.id = "cms-playing-origin", t.after(e), (0, se.createRoot)(e).render(/* @__PURE__ */ (0, w.jsx)(de, {}));
	}
}
